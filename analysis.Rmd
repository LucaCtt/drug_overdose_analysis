...
ggplot(data = missing, aes(
  ...
  geom_segment(aes(xend = row_name, y = 0, yend = missing), color = "grey") +
...
deaths %>%
  ...
  geom_segment( aes(xend=year, y=0, yend=count), color="grey") +
  geom_point(color = "blue",
             size = 3,
             alpha = 0.8) +
  coord_flip() +
...
deaths %>%
  ...
  geom_segment(aes(xend = month, y = 0, yend = count), color = "grey") +
  geom_point(color = "blue",
             size = 3,
             alpha = 0.8) +
  coord_flip() +
...
deaths %>%
  ...
  geom_segment(aes(xend = day, y = 0, yend = count), color = "grey") +
  geom_point(color = "blue",
             size = 3,
             alpha = 0.8) +
  coord_flip() +
  labs(title = "Deaths per day of week",
